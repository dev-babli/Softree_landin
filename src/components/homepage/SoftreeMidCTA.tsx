...
export function SoftreeMidCTA() {
  return (
    <section className="relative w-full bg-[#070707] border-y border-white/[0.06] overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse at center, rgba(255,87,34,0.5) 0%, rgba(132,152,230,0.3) 40%, transparent 70%)",
            filter: "blur(60px)",
          }}
        />
      </div>
      ...
      <div className="relative mx-auto flex w-full max-w-[1240px] flex-col items-center justify-center gap-0 px-5 pt-20 pb-0 md:gap-10 md:px-4 md:pt-[100px] z-10">
        ...
        <div className="flex flex-col items-center gap-5 px-0 pb-6 md:gap-6 text-center">
          <div className="flex flex-col items-center gap-3 md:gap-4">
            <h2 className="font-sans text-4xl text-white leading-[1.1] md:text-5xl lg:text-[60px] lg:leading-[1.0] font-black tracking-tight max-w-[700px]">
              Your vision is bold.<br className="md:hidden" />
              <span className="text-white/40"> We build it faster.</span>
            </h2>
            <p className="font-sans text-4xl text-white leading-[1.0] md:text-5xl lg:text-[60px] font-black tracking-tight">
              {/* intentionally empty to match Composio two-line layout */}
            </p>
          </div>
          <p className="max-w-[520px] text-center font-sans text-base text-white/45 leading-[1.5] md:text-lg">
            From AI automation to enterprise SharePoint systems — Softree turns your most complex requirements into production-grade software.
          </p>
        </div>

        {/* CTA button */}
        <div className="relative z-10 pb-14 md:pb-10">
          <a
            href="/contact"
            className="relative z-10 inline-block bg-white px-7 py-3 font-mono text-black text-sm font-bold leading-normal tracking-[-0.28px] transition-all duration-200 hover:bg-white/90 hover:scale-[1.03] active:scale-[0.97]"
          >
            GET STARTED
          </a>
        </div>
