      ...
      <div className="relative z-10 mx-auto w-full max-w-[1920px] overflow-hidden">
        ...
        <div className="mb-10 flex flex-grow justify-center lg:mb-12 w-full relative">
          <div className="w-full relative">
            <div
              ref={containerRef}
              className="flex snap-x snap-mandatory gap-5 overflow-x-auto overflow-y-hidden scroll-smooth no-scrollbar [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] w-full xl:justify-start"
              style={{
