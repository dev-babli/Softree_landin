...
export default function PricingSection() {
  ...
  return (
    <div className="w-full flex flex-col justify-center items-center gap-2 wf-surface">
      {/* Header Section */}
      <div className="self-stretch px-6 md:px-8 py-12 md:py-16 border-b wf-border flex justify-center items-center gap-6">
        <div className="w-full max-w-[586px] px-6 py-5 shadow-[0px_2px_4px_rgba(50,45,43,0.06)] overflow-hidden rounded-lg flex flex-col justify-start items-center gap-4 shadow-none">
          {/* Pricing Badge */}
          <div className="px-[14px] py-[6px] bg-white shadow-[0px_0px_0px_4px_rgba(55,50,47,0.05)] overflow-hidden rounded-[90px] flex justify-start items-center gap-[8px] border wf-border shadow-xs">
      ...
      <div className="self-stretch px-6 md:px-16 py-9 relative flex justify-center items-center gap-4">
        {/* Horizontal line */}
        <div className="w-full max-w-[1440px] h-0 absolute left-1/2 transform -translate-x-1/2 top-[63px] border-t wf-border z-0"></div>
      ...
      <div className="self-stretch border-b border-t wf-border flex justify-center items-center">
          ...
          <div className="flex-1 flex flex-col md:flex-row justify-center items-center gap-6 py-12 md:py-0">
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 border border-[rgba(50,45,43,0.12)] border-[#E0DEDB] overflow-hidden flex flex-col justify-start items-start gap-12 bg-[rgba(255,255,255,0)]">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                ...
                <div className="self-stretch">
                  <BorderGlow borderRadius={50} backgroundColor="#37322F" glowColor="25 100 50">
                    <div className="px-4 py-[10px] relative bg-[#37322F] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center cursor-pointer wf-btn-motion">
            ...
            <div className="flex-1 max-w-full md:max-w-none self-stretch px-6 py-5 bg-[#37322F] border border-[rgba(50,45,43,0.12)] border-[rgba(55,50,47,0.12)] overflow-hidden flex flex-col justify-start items-start gap-12">
              ...
              <div className="self-stretch flex flex-col justify-start items-center gap-9">
                ...
                {/* CTA Button */}
                <div className="self-stretch">
                  <BorderGlow borderRadius={50} backgroundColor="#FBFAF9" glowColor="25 100 50">
                    <div className="px-4 py-[10px] relative bg-[#FBFAF9] shadow-[0px_2px_4px_rgba(55,50,47,0.12)] overflow-hidden rounded-[99px] flex justify-center items-center cursor-pointer wf-btn-motion">
