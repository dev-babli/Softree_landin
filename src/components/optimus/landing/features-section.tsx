...
interface FeaturesSectionProps {
  /** Semantic surface for text and borders (defaults to light for this layout). */
  appearance?: DesignSystemAppearance;
}

export function FeaturesSection({ appearance = "light" }: FeaturesSectionProps) {
  const [isVisible, setIsVisible] = useState(false);
  ...
  return (
    <section
      id="features"
      ref={sectionRef}
      className={cn("relative py-24 lg:py-32", designSystemSurfaceClass(appearance))}
    >
