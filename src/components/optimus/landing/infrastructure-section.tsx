...
export function InfrastructureSection({ appearance = "dark" }: InfrastructureSectionProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className={cn("relative py-24 lg:py-32 overflow-hidden", designSystemSurfaceClass(appearance))}
    >
