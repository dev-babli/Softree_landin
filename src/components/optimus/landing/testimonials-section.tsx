...
const testimonials = [
  {
    quote: "Softree transformed our deployment pipeline. What used to take hours now happens in seconds.",
    author: "Sarah Chen",
    role: "CTO",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
          <div className="lg:col-span-8">
            ...
            >
              <div className="w-16 h-16 rounded-full bg-foreground/5 border border-foreground/10 flex items-center justify-center liquid-glass">
