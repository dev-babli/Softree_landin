  ...
  if (lines.length === 0) {
    return (
      <div className="flex h-full items-center">
        <p className="text-[20px] font-medium leading-snug tracking-tight text-[#141413] sm:text-[22px]">
...
const PathCard = memo(function PathCard({
  ...
  return (
    ...
    >
      ...
      {/* Card shell */}
      <div className="relative overflow-hidden rounded-[20px] border border-[#D1CDC7] bg-[#FCFBFA]/95 shadow-[0_30px_80px_-40px_rgba(0,0,0,0.9)] backdrop-blur-md">
        {/* Top gradient edge */}
        <div
        ...
        <div className="relative p-6 sm:p-7">
          ...
          <div className="mb-5 flex items-center justify-between">
            <span
              className="rounded-full border border-[#D1CDC7] bg-[#FCFBFA] px-3 py-1 font-mono text-[10px] font-semibold uppercase tracking-[0.22em]"
              style={{ color: card.accent }}
            >
              {card.label}
            </span>
            <span className="font-mono text-[10px] text-[#A39C92]">
          ...
          {/* Title */}
          <h3
            className="mb-4 text-base font-bold leading-tight tracking-tight text-[#141413] sm:text-lg"
          ...
          {/* Code block */}
          <div className="overflow-hidden rounded-[12px] border border-[#D1CDC7]/70 bg-[#F3F0EE]/95 p-4 shadow-[inset_0_1px_0_rgba(20,20,19,0.04)]">
            {/* Fake window chrome */}
            <div className="mb-3 flex items-center gap-1.5 border-b border-[#D1CDC7]/70 pb-3">
              <span className="h-2 w-2 rounded-full bg-[#ff5f56]" />
              <span className="h-2 w-2 rounded-full bg-[#ffbd2e]" />
              <span className="h-2 w-2 rounded-full bg-[#27c93f]" />
              <span className="ml-2 font-mono text-[9px] uppercase tracking-[0.18em] text-[#A39C92]">
                {card.id}.motion
              </span>
            </div>
...
export function LCCodePath() {
  ...
  useGSAP(
    () => {
      ...
      /* â”€â”€ 1. Horizontal scroll (pin + scrub) â”€â”€ */
      ...
      /* â”€â”€ 3. Card entrance (subtle y + opacity) â”€â”€ */
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden bg-[#F3F0EE] text-[#141413]"
      style={{ height: "100dvh" }}
    >
      {/* Grid background */}
      <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(20,20,19,0.03)_1px,transparent_1px),linear-gradient(180deg,rgba(20,20,19,0.025)_1px,transparent_1px)] bg-[size:64px_64px]" />
      ...
      <div className="pointer-events-none absolute left-6 top-6 z-20 sm:left-10 sm:top-10">
        <span className="inline-flex rounded-full border border-[#D1CDC7] bg-[#FCFBFA] px-3 py-1 font-mono text-[10px] uppercase tracking-[0.24em] text-[#696969]">
          Build Pipeline
        </span>
      </div>
        ...
        >
          <defs>
            ...
            >
              ...
              <stop offset="35%" stopColor="#ffa110" />
              <stop offset="65%" stopColor="#ffd900" />
