...
import { useRef, useCallback, useState, useEffect, type ReactNode, type FC } from 'react';
...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 25, s: 100, l: 50 }; // Softree Orange fallback: HSL(25, 100, 50)
...
const BorderGlow: FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '25 100 50', // Softree Orange HSL
  backgroundColor = '#F7F5F3', // Brilliance Light Theme Default
  borderRadius = 28,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#ff6b00', '#ff9f43', '#feca57'], // Softree Orange Palette
  fillOpacity = 0.5,
}) => {
